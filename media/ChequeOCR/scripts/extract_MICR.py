...
def find_ref_micr_data():
    directory = '/home/omkhade/chequeOCR/Bank-Cheque-OCR/ChequeProcessing/vision/ChequeOCR/'
...
def extract_micr(image):
    print(image,"bad is it")
    blackhat, gray, delta = extract_blackhat(image=image)
    print("done extract_blackhat")
