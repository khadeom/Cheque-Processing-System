...
def ext_ocr_details(img):	
	...
	cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/dilated.jpg', f_fill_img_inv)
	...
	cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/check_cont_.jpg', cv_img_bkp)
	...
	for key,value in cord_dict.items():
		if 'no' in key.strip().lower():
			...
			w = 1000
			h = 90
			cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/ac_no.jpg', img[y:y+h, x:x+w])
			ac_no = vision_api('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/ac_no.jpg')
			# print('ac_no ->', "".join(ac_no))
			ac_no = "".join(ac_no)
		...
		if 'ifs' in key.strip().lower():
			...
			#print('ifsc ->', (x, y, w, h))
			ifsc_pt = y+h 
			cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/ifsc.jpg', img[y:y+h, x:x+w])
			ifsc = vision_api('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/ifsc.jpg')
		...
		if 'sign' in key.strip().lower():
			...
			cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/org_signature.jpg', sign)
			sign = cv2.resize(sign, (200, 100))
			cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/signature.jpg', sign)
		...
		if 'bearer' in key.strip().lower():
			...
			cv2.imwrite('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/payee.jpg', bearer)
			bearer = vision_api('/home/gaurav/FinalProject/apps/vision/ChequeOCR/feilds/payee.jpg','bearer')
