...
#	  cv2.imwrite('init_ver_mask.jpg', vertical_mask)
	...
	# findContour returns countours, heirchy in cv version 4.6
	horizontal_contours = cv2.findContours(horizontal_line, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)[0]  
	vertical_contours = cv2.findContours(vertical_line, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)[0]
...
#	  final_mask = draw_horizontal_line(final_mask)
	...
	cv2.imwrite('/home/omkhade/chequeOCR/Bank-Cheque-OCR/ChequeProcessing/vision/ChequeOCR/final_mask.jpg', final_mask)
